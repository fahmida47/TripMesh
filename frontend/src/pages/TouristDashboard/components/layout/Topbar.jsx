import { BellIcon, ChevronDownIcon } from "./NavIcons";
import "./Topbar.css";
 ...
 * used on the page, so the topbar and the profile form never disagree.
 */
export default function Topbar({ profile, notificationCount = 3 }) {
